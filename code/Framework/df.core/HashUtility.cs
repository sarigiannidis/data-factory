...
namespace Df
{
    ...
    internal static class HashUtility
    {
        ...
        public static string ComputeSHA1Hash(Stream stream) =>
            ComputeHash(stream, SHA1.Create);

        public static string ComputeSHA256Hash(Stream stream) =>
            ComputeHash(stream, SHA256.Create);

        public static string ComputeSHA384Hash(Stream stream) =>
            ComputeHash(stream, SHA384.Create);

        public static string ComputeSHA512Hash(Stream stream) =>
            ComputeHash(stream, SHA512.Create);
